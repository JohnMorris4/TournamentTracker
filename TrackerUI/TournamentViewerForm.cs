...
namespace TrackerUI
{
    public partial class TournamentViewerForm : Form
    {
        ...
        private void LoadRounds()
        {
            ...
            foreach (List<MatchupModel> matchchups in tournament.Rounds)
            {
                if (matchchups.First().MatchupRound > currRound)
                {
                    currRound = matchchups.First().MatchupRound;
        ...
        /// <summary>
        /// Loads the matchups according to the dropdown
        /// </summary>
        ...
        private string ValidateData()
        {
            ...
            if (!scoreOneValid)
            {
                output = "The score one value is not a number.";
            }
            else if (!scoreTwoValid)
            {
                output = "The score two value is not a number.";
            }
